...
output_dir = '/Users/hahyeonji/Documents/AIV_Intern/ImageImbedding/data-gatter/NEW_TRAIN_NR'
...
def main():
    ...
    for cls in class_dirs:
        ...
        unique_images, similar_images = classify_images(class_path, min_count=min_count-1)  ###########
