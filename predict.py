...
def main():
    data_dir = './data-gatter/train'
    model_path = './model/mobilenetv2_aiv.pth' ####
    image_path = './data-gatter/test'
    ...
    model = mobilenet_v2(weights=None)  # (pretrained=False)
    ...
    print("Embeddings and labels extracted successfully.")
